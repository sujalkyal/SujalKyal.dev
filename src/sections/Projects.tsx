  ...
  return <section className="pb-16 lg:py-24">
    <div className="container">
      <div className="flex justify-center">
        ...
        text-transparent bg-clip-text text-center">Real-world Results</p>
      </div>
      <h2 className="text-center text-3xl md:text-5xl font-serif mt-6">Featured Projects</h2>
      ...
      <div className="flex flex-col mt-10 md:mt-20 gap-20">
        {portfolioProjects.map(project => (
          ...
          after:content-[''] after:z-10 after:absolute after:inset-0 after:outline-2 after:outline 
          ...
          md:pt-12 md:px-10 lg:pt-16 lg:px-20">
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-16">
              <div className="lg:pb-16">
                <div className="bg-gradient-to-r from-emerald-300 to-sky-400 font-bold inline-flex uppercase 
                ...
                <a href="{project.link}">
                  <button className="bg-white text-gray-950 h-12 w-full rounded-xl font-semibold inline-flex items-center 
                  justify-center gap-2 mt-8 md:w-auto md:px-6">
