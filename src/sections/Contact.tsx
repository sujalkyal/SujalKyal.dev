...
export const ContactSection = () => {
  return <section className='py-16 pt-12 lg:py-24 lg:pt-20' id='contact'>
    ...
    <div className='flex flex-col md:flex-row gap-8 md:gap-16 items-center'>
      <div>
    <h2 className='text-2xl md:text-3xl font-serif'>Let's create something amazing together</h2>
